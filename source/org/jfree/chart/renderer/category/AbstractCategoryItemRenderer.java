...
public abstract class AbstractCategoryItemRenderer extends AbstractRenderer
    ...
    public void drawRangeMarker(Graphics2D g2, CategoryPlot plot,
		...
		extracted(marker, axis, plot, dataArea, g2, edgeSupplier, PlotOrientation.VERTICAL,
				PlotOrientation.HORIZONTAL, textAnchorPointCalculationForLine, textAnchorPointCalculationForRectangle);
    }

    private void extracted(Marker marker, ValueAxis axis, CommonPlot plot2, Rectangle2D dataArea, Graphics2D g2,
			Supplier<RectangleEdge> edgeSupplier, PlotOrientation vertical, PlotOrientation horizontal,
			Interface3 textAnchorPointCalculationForLine, Interface4 textAnchorPointCalculationForRectangle) {
    	marker.draw(marker, axis, plot2, dataArea, g2, edgeSupplier, vertical, horizontal, textAnchorPointCalculationForLine, textAnchorPointCalculationForRectangle);
	}
